...
(function (root, factory) {
  ...
  function createSessionManager(deps) {
     ...
     * condition, so a 429 (and any other non-signout failure) is retried with
     * backoff instead, up to MAX_REFRESH_ATTEMPTS. A wait too long for this
     * worker to sleep through is parked in storage as a cooldown that a later
     * worker instance honours instead of re-hammering a limited IP.
     */
